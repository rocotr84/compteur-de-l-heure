...
# Lecture de la vidéo
cap = cv2.VideoCapture(r"D:\Windsuft programme\compteur-de-l-heure\assets\video\p3_macbeth.MP4")
...
while cap.isOpened():
    ...
    image_corrigee = corriger_image(frame, cache_file, detect_squares)
