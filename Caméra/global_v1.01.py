...
class TrackedPerson:
    ...
    def update(self, bbox, color=None):
        self.bbox = bbox
        if color:
            self.color = color
        self.disappeared = 0
        ...
        if len(self.trajectory) > 10:  # Limiter la taille de la trajectoire
...
class PersonTracker:
    ...
    def update(self, detections, colors):
        ...
        for bbox, color in zip(detections, colors):
            ...
            if best_match is not None:
                self.tracked_persons[best_match].update(bbox, color)
        ...
        # Supprimer les personnes disparues depuis trop longtemps
    ...
    while True:
        ...
        for result in results:
            ...
            for box, conf in zip(boxes, confidences):
                ...
                colors.append(None)  # À implémenter : détection de couleur
                
        # Mise à jour du tracker
        tracked_persons = tracker.update(detections, colors)
